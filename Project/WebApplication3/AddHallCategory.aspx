<%@ Page Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddHallCategory.aspx.cs" Inherits="WebApplication3.AddHallCategory" %>
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            ...
            <asp:Repeater ID="rptrCat" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        <th><%# Eval("HallCatID") %></th>
                        <td><%# Eval("HallCatName") %></td>
                        <td>Edit</td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
