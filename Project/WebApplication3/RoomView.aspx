<%@ Page Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="RoomView.aspx.cs" Inherits="WebApplication3.RoomView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Label ID="lbltest1" runat="server" Text="Label" visible="false"></asp:Label>
    <div class="row">
        <div class="col-lg-6 ">
