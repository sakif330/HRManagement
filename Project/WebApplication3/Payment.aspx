<%@ Page Language="C#"  AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="WebApplication3.Payment" %>
...
<body>
    ...
    <form id="form1" runat="server"  style="text-align:center; vertical-align: middle; height: 235px;">    
      ...
      <asp:Label ID="OiD" runat="server" Text="" Font-Bold="true" visible="true" ></asp:Label>
</body>
</html>
